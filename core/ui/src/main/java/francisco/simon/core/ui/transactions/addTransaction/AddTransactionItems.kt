    ...
    if (showDatePicker.value) {
        CustomDatePicker(
            selectedDate = Date.from(
                initialDate.value.atStartOfDay(ZoneId.systemDefault()).toInstant()
            ),
            onDateSelected = { date ->
...
@Composable
internal fun CommentInfo(transactionModel: MutableState<AddTransaction>) {
    CustomListItem(
        modifier = Modifier
            .height(70.dp),
        headlineContent = {
...
@Composable
internal fun AmountInfo(transactionModel: MutableState<AddTransaction>) {
    CustomListItem(
...
@Composable
internal fun AccountInfo(transactionModel: MutableState<AddTransaction>) {
    CustomListItem(
